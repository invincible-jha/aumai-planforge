# Contributing to AumAI Planforge
...
### Setup
```bash
git clone https://github.com/aumai/aumai-planforge.git
cd aumai-planforge
python -m venv .venv
...
### Good First Issues
New to the project? Start with issues labeled [`good first issue`](https://github.com/aumai/aumai-planforge/labels/good%20first%20issue).
...
- [GitHub Discussions](https://github.com/aumai/aumai-planforge/discussions)
